...
func main() {
	...
	// service 1
	node := kmicro.NewKMicro("service1", "1.0.0", kmicro.WithOtel(), kmicro.WithKnownHeaders(knownHeaders))
	...
	// service 2
	node2 := kmicro.NewKMicro("service2", "1.0.0", kmicro.WithOtel(), kmicro.WithKnownHeaders(knownHeaders))
	...
	// caller
	caller := kmicro.NewKMicro("caller", "1.0.0", kmicro.WithOtel(), kmicro.WithKnownHeaders(knownHeaders))
